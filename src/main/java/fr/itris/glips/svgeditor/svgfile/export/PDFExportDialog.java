...
public class PDFExportDialog extends ExportDialog{
     ...
     */
    protected String pdfTitle="", author="", subject="", keywords="", creator=""; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
     ...
     */
    public PDFExportDialog(SVGEditor editor, JFrame parentContainer) {
       ...
       if(bundle!=null){
            ...
            try{
                exportDialogTitle=bundle.getString("labelpdfexport"); //$NON-NLS-1$
    ...
    protected JTabbedPane getTabbedPane() {
        ...
        //getting the labels
        String pageTabLabel="", infoTabLabel=""; //$NON-NLS-1$ //$NON-NLS-2$
 
        if(bundle!=null){
            
            try{
                pageTabLabel=bundle.getString("labelexportpdftabpage"); //$NON-NLS-1$
                infoTabLabel=bundle.getString("labelexportpdftabinfo"); //$NON-NLS-1$
            }catch (Exception ex){}
        }
    ...
    protected JPanel getPageParametersPanel() {
        ...
        //getting the labels
        String exportSizeLabel="", predefLabel="", customLabel="", widthLabel="", heightLabel=""; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
 
        if(bundle!=null){
            
            try{
                predefLabel=bundle.getString("labelexportpredefinedsize"); //$NON-NLS-1$
                customLabel=bundle.getString("labelexportcustomsize"); //$NON-NLS-1$
        ...
        widthSpinner.addChangeListener(new ChangeListener(){
            ...
            public void stateChanged(ChangeEvent evt) {
                ...
                if(pageSize==null) {
                    ...
                    pageSize=new com.lowagie.text.Rectangle((float)((Double)widthSpinner.getValue()).doubleValue(), pageSize.getHeight());
                }
            }
        });
        ...
        heightSpinner.addChangeListener(new ChangeListener(){
            ...
            public void stateChanged(ChangeEvent evt) {
                ...
                if(pageSize==null) {
                    ...
                    pageSize=new com.lowagie.text.Rectangle(pageSize.getWidth(), (float)((Double)heightSpinner.getValue()).doubleValue());
                }
            }
        });
        ...
        //getting the labels
        String orientationLabel="", portraitLabel="", landscapeLabel=""; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        
        if(bundle!=null){
            
            try{
                orientationLabel=bundle.getString("labelexportorientation"); //$NON-NLS-1$
                portraitLabel=bundle.getString("labelexportportrait"); //$NON-NLS-1$
                landscapeLabel=bundle.getString("labelexportlandscape"); //$NON-NLS-1$
            }catch (Exception ex){}
        }
        ...
        //getting the labels
        String marginLabel="", topLabel="", bottomLabel="", leftLabel="", rightLabel=""; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
        
        if(bundle!=null){
            
            try{
                marginLabel=bundle.getString("labelexportmargin"); //$NON-NLS-1$
                topLabel=bundle.getString("labelexportmargintop"); //$NON-NLS-1$
                bottomLabel=bundle.getString("labelexportmarginbottom"); //$NON-NLS-1$
                leftLabel=bundle.getString("labelexportmarginleft"); //$NON-NLS-1$
                rightLabel=bundle.getString("labelexportmarginright"); //$NON-NLS-1$
            }catch (Exception ex){}
        }
        ...
        JLabel  topLbl=new JLabel(topLabel+" : "), bottomLbl=new JLabel(bottomLabel+" : "),  //$NON-NLS-1$ //$NON-NLS-2$
                    leftLbl=new JLabel(leftLabel+" : "), rightLbl=new JLabel(rightLabel+" : "), //$NON-NLS-1$ //$NON-NLS-2$
                    topPx=new JLabel("px"), bottomPx=new JLabel("px"), //$NON-NLS-1$ //$NON-NLS-2$
                    leftPx=new JLabel("px"), rightPx=new JLabel("px"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected JPanel getPageInformationPanel() {
        ...
        //getting the labels
        String titleLabel="", authorLabel="", subjectLabel="", keywordsLabel="", creatorLabel=""; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
 
        if(bundle!=null){
            
            try{
                titleLabel=bundle.getString("labelexporttitle"); //$NON-NLS-1$
                authorLabel=bundle.getString("labelexportauthor"); //$NON-NLS-1$
                subjectLabel=bundle.getString("labelexportsubject"); //$NON-NLS-1$
                keywordsLabel=bundle.getString("labelexportkeywords"); //$NON-NLS-1$
                creatorLabel=bundle.getString("labelexportcreator"); //$NON-NLS-1$
            }catch (Exception ex){}
        }
        
        //creating the jlabels
        JLabel  titleLbl=new JLabel(titleLabel+" : "), authorLbl=new JLabel(authorLabel+" : "),  //$NON-NLS-1$ //$NON-NLS-2$
                   subjectLbl=new JLabel(subjectLabel+" : "), keywordsLbl=new JLabel(keywordsLabel+" : "),  //$NON-NLS-1$ //$NON-NLS-2$
                   creatorLbl=new JLabel(creatorLabel+" : "); //$NON-NLS-1$
    ...
    protected static class PredefinedPageSizeItem{
         ...
         */
        protected static String label_11X17="", labelA0="", labelA1="", labelA10="", labelA2="",  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
                                                labelA3="", labelA4="", labelA5="", labelA6="", labelA7="", labelA8="",  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
                                                labelA9="", labelARCH_A="", labelARCH_B="", labelARCH_C="", labelARCH_D="",  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
                                                labelARCH_E="", labelB0="", labelB1="", labelB2="", labelB3="", labelB4="",  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
                                                labelB5="", labelFLSA="", labelFLSE="", labelHALFLETTER="", labelLEDGER="",  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
                                                labelLEGAL="", labelLETTER="", labelNOTE=""; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        static {
            ...
            if(bundle!=null){
                ...
                try{
                    label_11X17=bundle.getString("labelexportpdf_11X17");  //$NON-NLS-1$
                    labelA0=bundle.getString("labelexportpdfA0");  //$NON-NLS-1$
                    labelA1=bundle.getString("labelexportpdfA1");  //$NON-NLS-1$
                    labelA10=bundle.getString("labelexportpdfA10");  //$NON-NLS-1$
                    labelA2=bundle.getString("labelexportpdfA2");  //$NON-NLS-1$
                    labelA3=bundle.getString("labelexportpdfA3");  //$NON-NLS-1$
                    labelA4=bundle.getString("labelexportpdfA4");  //$NON-NLS-1$
                    labelA5=bundle.getString("labelexportpdfA5"); //$NON-NLS-1$
                    labelA6=bundle.getString("labelexportpdfA6");  //$NON-NLS-1$
                    labelA7=bundle.getString("labelexportpdfA7"); //$NON-NLS-1$
                    labelA8=bundle.getString("labelexportpdfA8");  //$NON-NLS-1$
                    labelA9=bundle.getString("labelexportpdfA9");  //$NON-NLS-1$
                    labelARCH_A=bundle.getString("labelexportpdfARCH_A");  //$NON-NLS-1$
                    labelARCH_B=bundle.getString("labelexportpdfARCH_B"); //$NON-NLS-1$
                    labelARCH_C=bundle.getString("labelexportpdfARCH_C"); //$NON-NLS-1$
                    labelARCH_D=bundle.getString("labelexportpdfARCH_D"); //$NON-NLS-1$
                    labelARCH_E=bundle.getString("labelexportpdfARCH_E"); //$NON-NLS-1$
                    labelB0=bundle.getString("labelexportpdfB0"); //$NON-NLS-1$
                    labelB1=bundle.getString("labelexportpdfB1");  //$NON-NLS-1$
                    labelB2=bundle.getString("labelexportpdfB2"); //$NON-NLS-1$
                    labelB3=bundle.getString("labelexportpdfB3");  //$NON-NLS-1$
                    labelB4=bundle.getString("labelexportpdfB4");  //$NON-NLS-1$
                    labelB5=bundle.getString("labelexportpdfB5");  //$NON-NLS-1$
                    labelFLSA=bundle.getString("labelexportpdfFLSA");  //$NON-NLS-1$
                    labelFLSE=bundle.getString("labelexportpdfFLSE");  //$NON-NLS-1$
                    labelHALFLETTER=bundle.getString("labelexportpdfHALFLETTER");  //$NON-NLS-1$
                    labelLEDGER=bundle.getString("labelexportpdfLEDGER");  //$NON-NLS-1$
                    labelLEGAL=bundle.getString("labelexportpdfLEGAL");  //$NON-NLS-1$
                    labelLETTER=bundle.getString("labelexportpdfLETTER");  //$NON-NLS-1$
                    labelNOTE=bundle.getString("labelexportpdfNOTE"); //$NON-NLS-1$
                }catch (Exception ex){}
            }
