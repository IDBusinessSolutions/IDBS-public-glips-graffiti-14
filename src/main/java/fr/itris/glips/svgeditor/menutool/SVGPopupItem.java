 ...
 * @author Jordi SUC
 */
public abstract class SVGPopupItem {
	 ...
	 * the font
	 */
	protected static Font theFont=new Font("theFont", Font.ROMAN_BASELINE, 10); //$NON-NLS-1$
	 ...
	 */
	public SVGPopupItem(SVGEditor editor, String id, String label, String iconName){
		...
		if(iconName!=null){
			...
			icon=editor.getResource().getIcon(iconName, false);
			disabledIcon=editor.getResource().getIcon(iconName, true);
		}
