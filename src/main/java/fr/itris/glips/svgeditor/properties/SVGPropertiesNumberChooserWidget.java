...
public class SVGPropertiesNumberChooserWidget extends SVGPropertiesWidget{
	...
	protected void buildComponent(){
	    ...
	    if(valueType.equals("positivenumberchooser")){ //$NON-NLS-1$
	        ...
	        spinnerModel=new SpinnerNumberModel(val, 0, 10000000, 1);
	        
	    }else{
	        
	        spinnerModel=new SpinnerNumberModel(val, -10000000, 10000000, 1);
	    }
	    
	    //the spinner
	    final JSpinner spinner=new JSpinner(spinnerModel);
	    spinner.setFont(theFont);
	    ...
	    final ChangeListener changeListener=new ChangeListener(){
            ...
            public void stateChanged(ChangeEvent evt) {
				...
				propertyItem.changePropertyValue(spinner.getModel().getValue()+""); //$NON-NLS-1$
            } 
	    };
