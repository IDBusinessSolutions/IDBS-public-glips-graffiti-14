...
public class SVGComboResourceItem{
	 ...
	 */
	public SVGComboResourceItem(SVGFrame frame, String value, String label, Element resource){
		...
		if(resource!=null){
			...
			resourceImage=frame.getSVGEditor().getResourceImageManager().getResourceRepresentation(frame, resource.getAttribute("id"), true); //$NON-NLS-1$
