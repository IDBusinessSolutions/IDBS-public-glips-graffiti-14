...
public class SVGVisualResourceState{
     ...
     */
    private Map itemsMap=Collections.synchronizedMap(new Hashtable());
    ...
    protected void setSelectedItemId(String tabId, String itemId) {
    	...
    	if(tabId!=null && ! tabId.equals("") && itemId!=null && ! itemId.equals("")){ //$NON-NLS-1$ //$NON-NLS-2$
