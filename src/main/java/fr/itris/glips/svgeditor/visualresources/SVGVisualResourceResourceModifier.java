...
public class SVGVisualResourceResourceModifier {
     ...
     * a small font
     */
    protected static final Font smallFont=new Font("smallFont", Font.ROMAN_BASELINE, 9); //$NON-NLS-1$
    
    /**
     * the font
     */
    protected static final Font theFont=new Font("theFont", Font.ROMAN_BASELINE, 10); //$NON-NLS-1$

    /**
     * the labels
     */
    private static String okLabel="", cancelLabel=""; //$NON-NLS-1$ //$NON-NLS-2$
     ...
     */
    public static int showPropertyModifierDialog(SVGVisualResourceObject resourceObject, SVGEditor editor){
    	...
    	if(resourceObject!=null){
		    ...
		    if(bundle!=null){
		        ...
		        try{
		            ...
		            title=title.concat(" ".concat(bundle.getString("vresource_properties"))); //$NON-NLS-1$ //$NON-NLS-2$
		        }catch (Exception ex){}
		    }
        ...
        if(resourceObject.getChildren().size()>0){
            ...
            if(child!=null){
                ...
                if(type!=null){
                    ...
                    if(type.equals("colorchooser")){ //$NON-NLS-1$
