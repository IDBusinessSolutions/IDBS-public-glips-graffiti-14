...
public class SVGVisualResourceObject{
    ...
    public SVGVisualResourceObject(Element resourceNode, Element initialNode, SVGVisualResourceModel resourceModel, LinkedList attributes, LinkedList children, boolean canBeModified){
        ...
        canCreateChildren=(! resourceNode.hasAttributeNS(SVGToolkit.xmlnsXLinkNS, "href")); //$NON-NLS-1$
    }
    ...
    protected String getResourceId(){
        ...
        SVGVisualResourceObjectAttribute att=null;
        String idValue="", name=""; //$NON-NLS-1$ //$NON-NLS-2$
        ...
        for(Iterator it=attributes.iterator(); it.hasNext();){
            ...
            if(att!=null){
                ...
                if(name!=null && name.equals("id")){ //$NON-NLS-1$
    ...
    protected SVGVisualResourceObjectChild createNewChild(){
        ...
        if(canCreateChildren){
            ...
            if(childModel!=null && resourceNode!=null && resourceNode.getOwnerDocument()!=null){
                ...
                final SVGFrame frame=resourceModel.getVisualResources().getSVGEditor().getFrameManager().getCurrentFrame();
                
                //creates a new child node
                final Element childElement=resourceModel.getVisualResources().getVisualResourcesToolkit().createVisualResourceChildStructure(frame, resourceNode);
    ...
    protected void removeChildResource(SVGVisualResourceObjectChild resChild){
        ...
        if(canCreateChildren && resChild!=null && frame!=null){
            
            //removes the child from the dom
            resourceModel.getVisualResources().getVisualResourcesToolkit().removeVisualResourceChild(frame, fresChild.getChildElement());
