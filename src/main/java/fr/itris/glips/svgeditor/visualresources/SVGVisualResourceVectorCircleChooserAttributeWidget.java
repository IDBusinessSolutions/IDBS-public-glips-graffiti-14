...
public class SVGVisualResourceVectorCircleChooserAttributeWidget extends SVGVisualResourceAttributeWidget{
    ...
    protected void buildComponent(){
        ...
        if(resourceObjectAttribute!=null){
            ...
            final SVGEditor svgEditor=resourceObjectAttribute.getModel().getVisualResources().getSVGEditor();
            ...
            final String gradientUnitsOther="userSpaceOnUse"; //$NON-NLS-1$
            String nm=""; //$NON-NLS-1$
            ...
            for(Iterator it=resourceObjectAttribute.getGroupAttributes().iterator();it.hasNext();){
                ...
                if(att!=null){
                    ...
                    if(nm.equals("x1")){ //$NON-NLS-1$
                        
                        px1Att=att;
                        
                    }else if(nm.equals("cx")){ //$NON-NLS-1$
                        
                        px1Att=att;
                        
                    }else if(nm.equals("y1")){ //$NON-NLS-1$
                        
                        py1Att=att;
                        
                    }else if(nm.equals("cy")){ //$NON-NLS-1$
                        
                        py1Att=att;
                        
                    }else if(nm.equals("x2")){ //$NON-NLS-1$
                        
                        px2Att=att;
                        
                    }else if(nm.equals("fx")){ //$NON-NLS-1$
                        
                        px2Att=att;
                        
                    }else if(nm.equals("y2")){ //$NON-NLS-1$
                        
                        py2Att=att;
                        
                    }else if(nm.equals("fy")){ //$NON-NLS-1$
                        
                        py2Att=att;
                        
                    }else if(nm.equals("r")){ //$NON-NLS-1$
                        
                        radiusAtt=att;
                        
                    }else if(nm.equals("gradientUnits")){ //$NON-NLS-1$
            ...
            if(gradientUnitsAtt!=null && px1Att!=null && py1Att!=null && px2Att!=null && py2Att!=null){
                ...
                vectChValues=new SVGVectorCircleChooserValues(defPoint1, defPoint2, defRadius, otherPoint1, otherPoint2, otherRadius, 
                																				isGradientUnitsDefault, type.equals("vectorchooser")); //$NON-NLS-1$
            }
            ...
            if(vectChValues!=null && px1Att!=null && py1Att!=null && px2Att!=null && py2Att!=null){
                ...
                nm="";  //$NON-NLS-1$
                String val="", lbl=""; //$NON-NLS-1$ //$NON-NLS-2$
                
                //an item with an empty string
                itm=new SVGComboItem("",""); //$NON-NLS-1$ //$NON-NLS-2$
                itmList.add(itm);
                ...
                for(Iterator it=possibleValues.keySet().iterator(); it.hasNext();){
                    ...
                    }catch (Exception ex){itm=null; nm="";} //$NON-NLS-1$
                ...
                String gradientUnitsLabel=""; //$NON-NLS-1$
                ...
                JLabel comboLabel=new JLabel(gradientUnitsLabel.concat(" :")); //$NON-NLS-1$
                ...
                //sets the properties for the textfields
                px1Txt.setFont(theFont);
                py1Txt.setFont(theFont);
                px2Txt.setFont(theFont);
                py2Txt.setFont(theFont);
                radiusTxt.setFont(theFont);
                
                //the labels corresponding to the entries
                final JLabel 	px1Lbl=new JLabel(px1Att.getModel().getName().concat("=")),  //$NON-NLS-1$
                					py1Lbl=new JLabel(py1Att.getModel().getName().concat("=")), //$NON-NLS-1$
                					px2Lbl=new JLabel(px2Att.getModel().getName().concat("=")),  //$NON-NLS-1$
                					py2Lbl=new JLabel(py2Att.getModel().getName().concat("=")),  //$NON-NLS-1$
                					radiusLbl=new JLabel();
                
                if(radiusAtt!=null){
                    
                    radiusLbl.setText(radiusAtt.getModel().getName().concat("=")); //$NON-NLS-1$
                }

                //sets the properties for the label
                px1Lbl.setFont(theFont);
                py1Lbl.setFont(theFont);
                px2Lbl.setFont(theFont);
                py2Lbl.setFont(theFont);
                radiusLbl.setFont(theFont);
                
                //sets the size for the labels
                Dimension lblSize=new Dimension(20, 20);
                px1Lbl.setPreferredSize(lblSize);
                px1Lbl.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                py1Lbl.setPreferredSize(lblSize);
                py1Lbl.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                px2Lbl.setPreferredSize(lblSize);
                px2Lbl.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                py2Lbl.setPreferredSize(lblSize);
                py2Lbl.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                radiusLbl.setPreferredSize(lblSize);
                ...
                //sets the properties for the label
                px1UnitLbl.setFont(theFont);
                py1UnitLbl.setFont(theFont);
                px2UnitLbl.setFont(theFont);
                py2UnitLbl.setFont(theFont);
                radiusUnitLbl.setFont(theFont);
                ...
                final SVGVectorCirclePanelListener vectorPanelListener=new SVGVectorCirclePanelListener(){
                    ...
                    protected void applyChanges(){
                        ...
                        if(items!=null && fvectChValues.isDefaultGradientUnits){
                            ...
                            fpx1Att.setValue(format.format(point1.x)+"%"); //$NON-NLS-1$
                            fpy1Att.setValue(format.format(point1.y)+"%"); //$NON-NLS-1$
                            fpx2Att.setValue(format.format(point2.x)+"%"); //$NON-NLS-1$
                            fpy2Att.setValue(format.format(point2.y)+"%"); //$NON-NLS-1$
                            
                            if(fradiusAtt!=null){
                                
                                fradiusAtt.setValue(format.format(items.getRadius())+"%"); //$NON-NLS-1$
                            }
                        }
                    }
                };
					...
					public void caretUpdate(CaretEvent evt) {
                        ...
                        if(evt.getSource().equals(px1Txt)){
                            ...
                            if(fvectChValues.isDefaultGradientUnits()){
                                ...
                                val=svgEditor.getSVGToolkit().getDoubleValue(px1Txt.getText().concat("%"), fvectChValues.isDefaultGradientUnits()); //$NON-NLS-1$
                                fvectChValues.getDefaultPoint1().x=val;
                                items.setPoint(fvectChValues.getDefaultPoint1(), SVGVectorCircleChooserItems.POINT1);
                                fpx1Att.setValue(format.format(val)+"%");        //$NON-NLS-1$
                            ...
                            if(fvectChValues.isDefaultGradientUnits()){
                                ...
                                val=svgEditor.getSVGToolkit().getDoubleValue(py1Txt.getText().concat("%"), fvectChValues.isDefaultGradientUnits()); //$NON-NLS-1$
                                fvectChValues.getDefaultPoint1().y=val;
                                items.setPoint(fvectChValues.getDefaultPoint1(), SVGVectorCircleChooserItems.POINT1);
                                fpy1Att.setValue(format.format(val)+"%");                          //$NON-NLS-1$
                                vectorPanelListener.refresh();
                            ...
                            if(fvectChValues.isDefaultGradientUnits()){
                                ...
                                val=svgEditor.getSVGToolkit().getDoubleValue(px2Txt.getText().concat("%"), fvectChValues.isDefaultGradientUnits()); //$NON-NLS-1$
                                fvectChValues.getDefaultPoint2().x=val;
                                items.setPoint(fvectChValues.getDefaultPoint2(), SVGVectorCircleChooserItems.POINT2);
                                fpx2Att.setValue(format.format(val)+"%");                          //$NON-NLS-1$
                                vectorPanelListener.refresh();
                            ...
                            if(fvectChValues.isDefaultGradientUnits()){
                                ...
                                val=svgEditor.getSVGToolkit().getDoubleValue(py2Txt.getText().concat("%"), fvectChValues.isDefaultGradientUnits()); //$NON-NLS-1$
                                fvectChValues.getDefaultPoint2().y=val;
                                items.setPoint(fvectChValues.getDefaultPoint2(), SVGVectorCircleChooserItems.POINT2);
                                fpy2Att.setValue(format.format(val)+"%"); //$NON-NLS-1$
                            ...
                            if(fvectChValues.isDefaultGradientUnits()){
                                ...
                                val=svgEditor.getSVGToolkit().getDoubleValue(radiusTxt.getText().concat("%"), fvectChValues.isDefaultGradientUnits()); //$NON-NLS-1$
                                fvectChValues.setDefaultRadius(val);
                                items.setRadius(fvectChValues.getDefaultRadius());
                                fradiusAtt.setValue(format.format(val)+"%");  //$NON-NLS-1$
                                vectorPanelListener.refresh();
                ...
                if(! vectChValues.isVectorChooser()){
                    ...
                    empty.setPreferredSize(lblSize);
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        if(val!=null && ! val.equals("")){ //$NON-NLS-1$
                            ...
                            if(fvectChValues.isDefaultGradientUnits()){
                                ...
                                px1Str=px1Str.concat("%"); //$NON-NLS-1$
                                py1Str=py1Str.concat("%"); //$NON-NLS-1$
                                px2Str=px2Str.concat("%"); //$NON-NLS-1$
                                py2Str=py2Str.concat("%"); //$NON-NLS-1$
                                radiusStr=py2Str.concat("%"); //$NON-NLS-1$
                            }
                            ...
                            if(fvectChValues.isDefaultGradientUnits()){
                                ...
                                px2Str=px2Str.concat("%"); //$NON-NLS-1$
                                py2Str=py2Str.concat("%"); //$NON-NLS-1$
                                radiusStr=radiusStr.concat("%"); //$NON-NLS-1$
