...
public class SVGColorManager {
	 ...
	 */
	private static Color currentColor=new Color(0, 0, 0); //changed to match arrow heads which must be black. Prob a better default anyhow LL 
	 ...
	 */
	public SVGColorManager(SVGEditor editor) {
	...
	public void setCurrentColor(Color currentColor){
	    ...
	    if(currentColor!=null){
			...
			SVGColorManager.currentColor=currentColor;
